...
export class TagService {
  ...
  deleteTagFormProduct(idTag: any, idProduct: any): Observable<Product> {
    return this.http.delete<Product>(`http://localhost:8080/api/deleteTagFormProduct/${idTag}/${idProduct}`);
  }
